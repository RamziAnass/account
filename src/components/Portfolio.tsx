...
const categories = ['All', 'Cartographie des Informations','Map Visualisations','Rapports et études de Cas','Livrables de Veille','Vidéos Explicatives'];

const projects = [
  {
    title: 'Visualisation de Carte des Pays Leaders en IA En 2024 ',
    description: 'Machine learning model to predict future sales trends.',
  ...
  {
    title: 'Visualisation de carte des Top 5 Pays Européens Leaders En Transition Energétique En 2024',
